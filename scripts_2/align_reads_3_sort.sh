...
f1="/proj/snic2021-23-431/private/data/rawdata_cp/TEST/"*R1_001.fastq.gz
f2="/proj/snic2021-23-431/private/data/rawdata_cp/TEST/"*R2_001.fastq.gz
#ls $f1
...
mkdir /proj/snic2021-23-431/nobackup/aligned/TEST/

STAR --genomeDir /proj/snic2021-23-431/private/reference/potatogenome/ --readFilesIn $f1 $f2 --runThreadN 8 --readFilesCommand zcat --outFileNamePrefix /proj/snic2021-23-431/nobackup/aligned/TEST/ --outSAMtype BAM SortedByCoordinate --outFilterScoreMinOverLread 0.25 --outFilterMatchNminOverLread 0.25 --outFilterMismatchNmax 2 
